...
class PublicTransportationController extends Controller
{
    public function index(Request $request): View
    {
        ...
        $services = TourismService::query()
            ...
            ->whereHas('serviceProvider', fn ($query) => $query->where('provider_type', 'transportation_car_rental'))
    ...
    public function show(TourismService $tourismService): View
    {
        ...
        abort_unless($tourismService->serviceProvider?->provider_type === 'transportation_car_rental', 404);
