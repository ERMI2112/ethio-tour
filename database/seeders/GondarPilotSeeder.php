    ...
    private function seedGondarAttractions(): void
    {
        ...
        $attractions = [
            [
                ...
                'images' => [
                    [
                        'path' => '/images/attractions/fasil-ghebbi-restored-front.jpg',
                        'alt' => 'Grand monumental entrance arch and restored Fasilides Castle at Fasil Ghebbi in Gondar',
                        'attribution' => 'Restored Fasil Ghebbi Grand Entrance & Palace',
                        'is_primary' => true,
                    ],
                    [
                        'path' => '/images/attractions/fasil-ghebbi-restored-panorama.jpg',
                        'alt' => 'Restored royal enclosure palaces and manicured green lawns at Fasil Ghebbi in Gondar',
                        'attribution' => 'Fasil Ghebbi Royal Palace Enclosure',
                        'is_primary' => false,
                    ],
                    [
                        'path' => '/images/attractions/fasil-ghebbi-restored-courtyard.jpg',
                        'alt' => 'Restored stone arches, royal library and castle courtyard at Fasil Ghebbi in Gondar',
                        'attribution' => 'Fasil Ghebbi Courtyard & Royal Library',
                        'is_primary' => false,
                    ],
                    [
                        'path' => '/images/attractions/fasil-ghebbi-restored-towers.jpg',
                        'alt' => 'Emperor Fasilides Castle watchtowers, stone battlements and blue sky at Fasil Ghebbi in Gondar',
                        'attribution' => 'Fasilides Castle Towers & Ramparts',
                        'is_primary' => false,
                    ],
                    [
                        'path' => '/images/attractions/fasil-ghebbi-aerial.jpg',
                        'alt' => 'Aerial panorama of Fasil Ghebbi Royal Enclosure castle complex in Gondar',
                        'attribution' => 'Fasil Ghebbi Aerial Panorama',
                        'is_primary' => false,
                    ],
                ],
            ],
            [
                ...
                'images' => [
                    [
                        'path' => '/images/attractions/debre-berhan-selassie-exterior.jpg',
                        'alt' => 'Exterior of Debre Berhan Selassie Church adorned with Ethiopian tricolor banners in Gondar',
                        'attribution' => 'Debre Berhan Selassie Church Exterior',
                        'is_primary' => true,
                    ],
                    [
                        'path' => '/images/attractions/debre-berhan-selassie-murals.jpg',
                        'alt' => 'Winged angel ceiling and iconic biblical wall murals inside Debre Berhan Selassie Church',
                        'attribution' => 'Debre Berhan Selassie Murals & Angel Ceiling',
                        'is_primary' => false,
                    ],
                ],
            ],
